...
if __name__ == "__main__":
    ...
    parser.add_argument("sample_image_path", help="Path ke gambar sampel fingerprint.")
    parser.add_argument("dataset_folder", help="Folder tempat gambar dataset fingerprint berada.")
